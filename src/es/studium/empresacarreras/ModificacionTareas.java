...
public class ModificacionTareas implements WindowListener, ActionListener {
	...
	Frame ventana = new Frame("Modificación de Tarea");
	Label lblCabecera = new Label("Elegir Tarea...");
	Choice choTareas = new Choice();
	Button btnEditar = new Button("Editar");

	Dialog dlgEditar = new Dialog(ventana, "Edición Tarea", true);
	Label lblCabecera2 = new Label ("Editando tarea nº ");
	Label lblId = new Label("Nº Tarea: ");
